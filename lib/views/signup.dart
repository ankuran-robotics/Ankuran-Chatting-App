...
import 'package:chatting_app/views/chatRoomsScreen.dart';
                          ...
                          children: [
                            TextFormField(
                              validator: (val) {
                                return val.isEmpty || val.length < 4
                                    ? "Please provide a valid username \nRemember that the length of username should be more \nthan 4 characters"
                                    : null;
                              },
                            ...
                            TextFormField(
                              ...
                              validator: (val) {
                                return val.length > 6
                                    ? null
                                    : "Please provide a Strong password of 6+ characters";
                              },
